...
exports.default = _default;
},{"./downloadAsFile":"src/downloadAsFile.js"}],"src/moveCanvas.js":[function(require,module,exports) {
"use strict";
...
var moveCanvas = function moveCanvas(movingElement) {
...
function parseSVGString(svgString) {
  ...
  var svgDOM = parser.parseFromString(svgString, 'image/svg+xml').getElementsByTagName('svg')[0];
  var svgViewBox = svgDOM.attributes.viewBox.value;
  var svgFill = svgDOM.attributes.fill ? svgDOM.attributes.fill.value : 'none'; // console.log(svgDOM.children);
  // console.log(svgElement);

  var parsedSVGWidth = svgDOM.attributes.width ? svgDOM.attributes.width.value : 500;
  var parsedSVGheight = svgDOM.attributes.height ? svgDOM.attributes.height.value : 500;
  var newContainerHeight = Math.round(width / (parsedSVGWidth / parsedSVGheight));
  svgContainer.style.height = "".concat(newContainerHeight, "px");
...
function init() {
  ...
  warp.interpolate(40); // Start with a rectangle, then distort it later
  ...
  function drawCircle(element) {
    ...
    _Draggable.default.create(circle, {
      type: 'x,y',
      // bounds: svgControl,
      onDrag: function onDrag() {
        var relativeX = this.pointerX - svgControl.getBoundingClientRect().left;
        var relativeY = this.pointerY - svgControl.getBoundingClientRect().top;
  ...
  if (firstInit) {
    controlPoints = [[-40, 70], [10, 180], [-20, 275], [130, 420], [160, 184], [400, 470], [540, 350], [450, 90], [260, 6], [500, 30], [460, -10], [110, -80]];
  }
