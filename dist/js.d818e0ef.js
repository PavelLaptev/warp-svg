...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
    ...
    'node_modules/warpjs/dist/warp.js': [
      function (require, module, exports) {
        var define;
        /*! Warp.js v1.0.8 (MIT) */
        !(function (e, t) {
            ...
            function (e, t, r) {
              ...
              function o(e, t) {
                if (e.type === t.type && e.relative === t.relative) {
                  ...
                  return (
                    t.extended && t.extended[2] && (u[2] = t.extended[2]), y
                  );
                }
                return !1;
              }
            ...
            function (e, t, r) {
              ...
              function a(e, t) {
                for (
                  ...
                  var l = a.pop();
                  if (r(l) > t)
                    for (var u = n(l), y = u.length - 1; y >= 0; y--)
                      a.push(u[y]);
                  else o.push(l);
                }
                return o;
                  ...
                  for (
                    ...
                    if (c in t) {
                      ...
                      try {
                        for (
                          var g,
                            m = Array.from(y.attributes)[Symbol.iterator]();
                          !(d = (g = m.next()).done);
                          d = !0
                        ) {
                          var b = g.value,
                ...
                return (0, l.default)(e, function (e) {
                  for (var r = 0; r < u.pointGroups.length; r++) {
                    ...
                    if (o in e && l in e) {
                      ...
                      if (c.length < 2)
                        throw new Error(
                          'Transformer must return at least 2 points'
                        );
                      (e[o] = c[0]),
                        (e[l] = c[1]),
                        c.length > 2 &&
...
*/
  ...
  */
    ...
    'node_modules/gsap/Draggable.js': [
      function (require, module, exports) {
        ...
        var gsap,
          ...
          _getElementBounds = function _getElementBounds(element, context) {
            ...
            matrix = (0, _matrix.getGlobalMatrix)(context, true).multiply(
              (0, _matrix.getGlobalMatrix)(element)
            );
            p1 = matrix.apply({
              x: left,
              y: top,
            ...
            if (_windowExists() && document.body) {
              ...
              _touchEventLookup = (function (types) {
                ...
                var standard = types.split(','),
                  converted = (!_isUndefined(_tempDiv.onpointerdown)
                    ? 'pointerdown,pointermove,pointerup,pointercancel'
                    : !_isUndefined(_tempDiv.onmspointerdown)
          ...
          function Draggable(target, vars) {
            ...
            var type = (vars.type || 'x,y').toLowerCase(),
              ...
              calculateBounds = function calculateBounds() {
                ...
                if (vars.liveSnap) {
                  snap =
                    vars.liveSnap === true ? vars.snap || {} : vars.liveSnap;
              ...
              updateMatrix = function updateMatrix(shiftStart) {
                ...
                if (
                  shiftStart &&
                  self.isPressed &&
                  !matrix.equals(start || new _matrix.Matrix2D())
                ) {
                ...
                if (scrollProxy) {
                  ...
                  if (rotationMode) {
                    parsedOrigin = target.ownerSVGElement
                      ...
                      : (
                          _getComputedStyle(target)[_transformOriginProp] ||
                          '0 0'
                        ).split(' ');
                    rotationOrigin = self.rotationOrigin = (0,
                    _matrix.getGlobalMatrix)(target).apply({
              ...
              onMove = function onMove(e) {
                ...
                setPointerPosition(
                  e.pageX -
                    (isFixed && rotationMode ? _getDocScrollLeft(ownerDoc) : 0),
                  e.pageY -
                    (isFixed && rotationMode ? _getDocScrollTop(ownerDoc) : 0),
                  hasMoveCallback
                );
              },
              setPointerPosition = function setPointerPosition(
                ...
                if (rotationMode) {
                  ...
                  if (matrix) {
                    ...
                    pointerY =
                      pointerX * matrix.b + pointerY * matrix.d + matrix.f;
                    pointerX = temp;
                  }
      ...
      { './utils/matrix.js': 'node_modules/gsap/utils/matrix.js' },
    ],
    'src/js/chunks/dropzone.js': [
      function (require, module, exports) {
        ...
        var dropZone = function dropZone(callback) {
          var dropZonePreview = document.getElementsByClassName(
            'dropzone-preview'
          )[0];
    ...
    'src/js/chunks/generateMeshPoints.js': [
      function (require, module, exports) {
        ...
        var generateMeshPoints = function generateMeshPoints(
          width,
          height,
          amount
        ) {
          var checkAndRoundNumber = function checkAndRoundNumber(
            length,
            index
          ) {
          ...
          var myTop = _toConsumableArray(Array(amount).keys())
            .map(function (item, i) {
          ...
          return [].concat(
            _toConsumableArray(myleft),
            _toConsumableArray(myBottom),
            _toConsumableArray(myRight),
            _toConsumableArray(myTop)
          );
        };
    ...
    'src/js/chunks/saveResults.js': [
      function (require, module, exports) {
        ...
        var _downloadAsFile = _interopRequireDefault(
          require('./downloadAsFile')
        );
      ...
      { './downloadAsFile': 'src/js/chunks/downloadAsFile.js' },
    ],
    'src/js/chunks/moveAndScaleCanvas.js': [
      function (require, module, exports) {
        'use strict';
      ...
      { 'gsap/Draggable': 'node_modules/gsap/Draggable.js' },
    ],
    ...
    'src/assets/svg-test-strings.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'src/js/index.js': [
      function (require, module, exports) {
        ...
        var _dropzone = _interopRequireDefault(require('./chunks/dropzone'));

        var _generateMeshPoints = _interopRequireDefault(
          require('./chunks/generateMeshPoints')
        );

        var _saveResults = _interopRequireDefault(
          require('./chunks/saveResults')
        );

        var _moveAndScaleCanvas = _interopRequireDefault(
          require('./chunks/moveAndScaleCanvas')
        );

        var _toggleControls = _interopRequireDefault(
          require('./chunks/toggleControls')
        );

        var _changeTheme = _interopRequireDefault(
          require('./chunks/changeTheme')
        );
        ...
        function parseSVGString(svgString) {
          var svgDOM = new DOMParser()
            .parseFromString(svgString, 'image/svg+xml')
            .getElementsByTagName('svg')[0];
          var parsedSVGWidth = svgDOM.attributes.width
            ? Number(svgDOM.attributes.width.value.replace(/^.*?(\d+).*/, '$1'))
            : 500;
          var parsedSVGheight = svgDOM.attributes.height
            ? Number(
                svgDOM.attributes.height.value.replace(/^.*?(\d+).*/, '$1')
              )
            : 500;
        ...
        function init() {
          ...
          warp.transform(function (v0) {
            ...
            for (var i = 0; i < V.length; i++) {
              ...
              var vj = V[j];
              var r0i = Math.sqrt(
                Math.pow(v0[0] - vi[0], 2) + Math.pow(v0[1] - vi[1], 2)
              );
              var r0j = Math.sqrt(
                Math.pow(v0[0] - vj[0], 2) + Math.pow(v0[1] - vj[1], 2)
              );
              var rij = Math.sqrt(
                Math.pow(vi[0] - vj[0], 2) + Math.pow(vi[1] - vj[1], 2)
              );
              var dn = 2 * r0i * r0j;
              var r =
                (Math.pow(r0i, 2) + Math.pow(r0j, 2) - Math.pow(rij, 2)) / dn;
            ...
            for (var _j = 0; _j < V.length; _j++) {
              ...
              var _r = Math.sqrt(
                Math.pow(_vj[0] - v0[0], 2) + Math.pow(_vj[1] - v0[1], 2)
              );
        ...
        var createNewControlPath = function createNewControlPath() {
          ...
          var newControlPath = document.createElementNS(
            'http://www.w3.org/2000/svg',
            'path'
          );
        ...
        document.addEventListener('wheel', function (e) {
          ...
          if (e.wheelDelta > 0) {
            ...
            if (zoomElement.getBoundingClientRect().width >= 30) {
              zoomElement.style.transform = 'scale('.concat(
                (zoom -= 0.02),
                ')'
              );
        ...
        (0, _saveResults.default)(
          document.getElementById('save-result-btn'),
          svgElement
        );
      ...
      },
      {
        ...
        warpjs: 'node_modules/warpjs/dist/warp.js',
        gsap: 'node_modules/gsap/index.js',
        'gsap/Draggable': 'node_modules/gsap/Draggable.js',
        './chunks/dropzone': 'src/js/chunks/dropzone.js',
        './chunks/generateMeshPoints': 'src/js/chunks/generateMeshPoints.js',
        './chunks/saveResults': 'src/js/chunks/saveResults.js',
        './chunks/moveAndScaleCanvas': 'src/js/chunks/moveAndScaleCanvas.js',
        './chunks/toggleControls': 'src/js/chunks/toggleControls.js',
        './chunks/changeTheme': 'src/js/chunks/changeTheme.js',
        '../assets/svg-test-strings': 'src/assets/svg-test-strings.js',
      },
    ],
